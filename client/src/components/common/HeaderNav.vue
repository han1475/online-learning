    ...
    <header class="top-nav-container">
      <nav class="top-nav">
        <a v-link="{ path: '/posts', activeClass: 'active' }" class="vertical-center nav-logo">
          ...
          <span class="brand vertical-center-content">在线学习网站</span>
        </a>
        <ul class="nav-link-container">
          <li class="nav-link-item"><search></search></li>
          <li class="nav-link-item"><a class="nav-link" v-link="{ path: '/posts', activeClass: 'active' }" >课程</a></li>
          <li class="nav-link-item"><a class="nav-link" v-link="{ path: '/tags', activeClass: 'active' }">标签</a></li>
          <li class="nav-link-item"><a class="nav-link" v-link="{ path: '/me', activeClass: 'active' }">关于我们</a></li>
        </ul>
